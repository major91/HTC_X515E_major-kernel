...
ARCH		?= arm
CROSS_COMPILE	?= /home/major/kernel/linaro_4.8.2/bin/arm-cortex_a8-linux-gnueabi-
...
ifdef CONFIG_CC_OPTIMIZE_ALOT
KBUILD_CFLAGS  += -O3 -s -Ofast -mcpu=cortex-a8 -march=armv7-a -mfloat-abi=softfp -mfpu=neon -funsafe-math-optimizations -mvectorize-with-neon-quad -fmodulo-sched -fmodulo-sched-allow-regmoves -fno-tree-vectorize
endif
